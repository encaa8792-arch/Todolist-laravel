        ...
        <div class="register-card">
            ...
            <form method="POST" action="/register" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="nameInput" placeholder="Masukkan nama lengkap" value="<?php echo e(old('name')); ?>" required autofocus>
                    <span class="error-text">Nama wajib diisi</span>
                </div>
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" id="emailInput" placeholder="Masukkan email" value="<?php echo e(old('email')); ?>" required>
...
<?php /**PATH C:\laragon\www\Todolist\resources\views/auth/register.blade.php ENDPATH**/ ?>