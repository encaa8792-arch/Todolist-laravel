...
<html>
<head>
    <title><?php echo $__env->yieldContent('title', 'Todo List'); ?></title>
    <meta charset="UTF-8">
    ...
    <div class="layout-wrapper">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <a href="/dashboard" class="menu-item <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>" data-tooltip="Dashboard">
                    <i class="bi bi-house-door"></i>
                    <span class="label">Dashboard</span>
                </a>
                <a href="/tasks" class="menu-item <?php echo e(request()->is('tasks') ? 'active' : ''); ?>" data-tooltip="Tugas">
                    <i class="bi bi-list-task"></i>
                    <span class="label">Tugas</span>
                </a>
                <a href="/tasks/completed" class="menu-item <?php echo e(request()->is('tasks/completed') ? 'active' : ''); ?>" data-tooltip="Tugas Selesai">
                ...
                <a href="/categories" class="menu-item <?php echo e(request()->is('categories') ? 'active' : ''); ?>" data-tooltip="Kategori">
                    <i class="bi bi-folder"></i>
                    <span class="label">Kategori</span>
                </a>
                <a href="/reports" class="menu-item <?php echo e(request()->is('reports') ? 'active' : ''); ?>" data-tooltip="Laporan">
                ...
                <div class="page-topbar-right">
                    ...
                    <div class="user-profile" id="userProfileBtn">
                        <?php if(auth()->user()->avatar && \Illuminate\Support\Facades\Storage::disk('public')->exists(auth()->user()->avatar)): ?>
                            <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" class="user-avatar-img" alt="Profil">
                        <?php else: ?>
    ...
    <div id="photoModal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,0.5); z-index:2000; justify-content:center; align-items:center;">
        <div style="background:white; border-radius:20px; padding:30px; max-width:400px; width:90%; position:relative;">
            ...
            <div style="text-align:center;">
                <?php if(auth()->user()->avatar && \Illuminate\Support\Facades\Storage::disk('public')->exists(auth()->user()->avatar)): ?>
                    <img id="photoPreview" src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" style="width:100px; height:100px; border-radius:50%; object-fit:cover; margin-bottom:20px; border:3px solid var(--theme-border);">
                <?php else: ?>
