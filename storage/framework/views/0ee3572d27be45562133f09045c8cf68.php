        ...
        <div class="forgot-card">
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" placeholder="Masukkan email terdaftar" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
                ...
                <div class="back-login-link">
                    Sudah ingat password? <a href="<?php echo e(route('login')); ?>">Masuk di sini</a>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\Todolist\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>