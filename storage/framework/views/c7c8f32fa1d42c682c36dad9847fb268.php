        ...
        <div class="task-list" id="taskList">
            <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="task-item <?php echo e($task->is_done ? 'done' : ''); ?> <?php echo e($isOverdue ? 'overdue' : ''); ?>"
                    ...
                    <input type="checkbox" class="task-checkbox" data-id="<?php echo e($task->id); ?>" onchange="updateBulkBar()">
                    <div class="task-info">
                        <div class="task-top">
                            <?php if($task->category): ?>
                                <span class="task-category"><?php echo e($task->category); ?></span>
                            <?php endif; ?>
                            <span class="task-name"><?php echo e($task->task); ?></span>
                        </div>
                        <div class="task-dates">
                            ...
                            <?php if($task->deadline): ?>
                                <span class="task-date selesai <?php echo e($isOverdue ? 'overdue' : ''); ?>">
