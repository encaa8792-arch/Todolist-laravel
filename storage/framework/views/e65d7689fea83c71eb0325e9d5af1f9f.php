    ...
    <div class="layout-wrapper">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <a href="/dashboard" class="menu-item <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>">
                    <span class="icon">🏠</span>
                    <span class="label">Dashboard</span>
                    <span class="tooltip">Dashboard</span>
                </a>
                <a href="/tasks" class="menu-item <?php echo e(request()->is('tasks') ? 'active' : ''); ?>">
                    <span class="icon">📋</span>
                    <span class="label">Tugas</span>
                    <span class="tooltip">Tugas</span>
                </a>
                <a href="/tasks/completed" class="menu-item <?php echo e(request()->is('tasks/completed') ? 'active' : ''); ?>">
                    <span class="icon">✓</span>
                ...
                <a href="/categories" class="menu-item <?php echo e(request()->is('categories') ? 'active' : ''); ?>">
                    <span class="icon">📁</span>
                    <span class="label">Kategori</span>
                    <span class="tooltip">Kategori</span>
                </a>
                <a href="/reports" class="menu-item <?php echo e(request()->is('reports') ? 'active' : ''); ?>">
                    <span class="icon">📊</span>
                    <span class="label">Laporan</span>
                    <span class="tooltip">Laporan</span>
                </a>
                <a href="/settings" class="menu-item <?php echo e(request()->is('settings') ? 'active' : ''); ?>">
