...
<?php $__env->startSection('content'); ?>
    ...
    <div class="completed-list">
        <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="completed-item" id="completed-task-<?php echo e($task->id); ?>">
                <input type="checkbox" class="completed-checkbox completed-cb" data-id="<?php echo e($task->id); ?>" onchange="updateCompletedBulkBar()">
                ...
                <div class="completed-btns">
                    <form method="POST" action="/tasks/<?php echo e($task->id); ?>/done" style="display:inline;" class="ajax-restore">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="btn-icon restore" data-tooltip="Kembalikan">↩️</button>
                    </form>
                    <form method="POST" action="/tasks/<?php echo e($task->id); ?>" style="display:inline;" class="ajax-delete">
                        <?php echo csrf_field(); ?>
